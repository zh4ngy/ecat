 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x1000 = {DEFTYPE_UNSIGNED32, 0x20,
                                                      ACCESS_READ};
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x1001 = {DEFTYPE_UNSIGNED8, 0x08,
                                                      ACCESS_READ};
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x1008 = {DEFTYPE_VISIBLESTRING,
                                                      BYTE2BIT(DEVICE_NAME_LEN), ACCESS_READ};
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x1009 = {DEFTYPE_VISIBLESTRING,
                                                      BYTE2BIT(DEVICE_HW_VERSION_LEN), ACCESS_READ};
 ...
 * \brief 0x1009 (Hardware version) entry description
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x100A = {DEFTYPE_VISIBLESTRING,
                                                      BYTE2BIT(DEVICE_SW_VERSION_LEN), ACCESS_READ};
 ...
 */
TOBJ1018 sIdentity = {4, (VENDOR_ID), (PRODUCT_CODE), (REVISION_NUMBER),
                      (SERIAL_NUMBER)};
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x1018[] = {{DEFTYPE_UNSIGNED8,
                                                                              0x8,  ACCESS_READ},
                                                         {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
                                                         {
                                                          DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
                                                         {DEFTYPE_UNSIGNED32, 0x20,
                                                                                    ACCESS_READ},
                                                         {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ}};
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1018[] =
        "Identity\000Vendor ID\000Product code\000Revision\000Serial number\000\377";
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x10F1[] = {{DEFTYPE_UNSIGNED8,
                                                                              0x8,  ACCESS_READ},
 ...
 */
OBJCONST UCHAR OBJMEM aName0x10F1[] =
        "Error Settings\000Local Error Reaction\000Sync Error Counter Limit\000\377";
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM sEntryDesc0x10F8 = {DEFTYPE_UNSIGNED64, 0x40,
                                                      ACCESS_READWRITE | OBJACCESS_TXPDOMAPPING};
 ...
 */
UINT8 Read0x10F8(UINT16 index, UINT8 subindex, UINT32 dataSize,
...
void COE_SyncTimeStamp(void) {
  ...
  if (b32BitDc) {
    ...
    u64Timestamp = ((u64Timestamp & ((UINT64) 0xFFFFFFFF00000000))
                    | (UINT64) DcTime);
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x1C00[] = {{DEFTYPE_UNSIGNED8,
                                                                             0x08, ACCESS_READ},
 ...
 */
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x1C3x[] = {{DEFTYPE_UNSIGNED8,
                                                                              0x8,  ACCESS_READ}, /* Subindex 000 */
                                                         {DEFTYPE_UNSIGNED16, 0x10, (ACCESS_READ |
                                                                                     ACCESS_WRITE_PREOP)}, /* SubIndex 001: Synchronization Type */
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1C32[] =
        "SM output parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";

/**
 * \brief 0x1C33 (SyncManager 3 parameter) object and entry names
 */
OBJCONST UCHAR OBJMEM aName0x1C33[] =
        "SM input parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";
...
/* Object 0x1000 */
        {NULL, NULL, 0x1000, {DEFTYPE_UNSIGNED32,    0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x1000, aName0x1000, &u32Devicetype,            NULL, NULL, 0x0000},
/* Object 0x1001 */
        {NULL, NULL, 0x1001, {DEFTYPE_UNSIGNED8,     0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x1001, aName0x1001, &u16ErrorRegister,         NULL, NULL, 0x0000},
/* Object 0x1008 */
        {NULL, NULL, 0x1008, {DEFTYPE_VISIBLESTRING, 0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x1008, aName0x1008, acDevicename,              NULL, NULL, 0x0000},
/* Object 0x1009 */
        {NULL, NULL, 0x1009, {DEFTYPE_VISIBLESTRING, 0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x1009, aName0x1009, acHardwareversion,         NULL, NULL, 0x0000},
/* Object 0x100A */
        {NULL, NULL, 0x100A, {DEFTYPE_VISIBLESTRING, 0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x100A, aName0x100A, acSoftwareversion,         NULL, NULL, 0x0000},
/* Object 0x1018 */
        {NULL, NULL, 0x1018, {DEFTYPE_IDENTITY,      4 | (OBJCODE_REC << 8)},
                asEntryDesc0x1018, aName0x1018, &sIdentity,                NULL, NULL, 0x0000},
/* Object 0x10F1 */
        {NULL, NULL, 0x10F1, {DEFTYPE_RECORD,        2 | (OBJCODE_REC << 8)},
                asEntryDesc0x10F1, aName0x10F1, &sErrorSettings,           NULL, NULL, 0x0000},
        /*ECATCHANGE_START(V5.12) COE4*/
        /* Object 0x10F8 */
        {NULL, NULL, 0x10F8, {DEFTYPE_UNSIGNED64,    0 | (OBJCODE_VAR << 8)},
                &sEntryDesc0x10F8, aName0x10F8, &u64Timestamp, Read0x10F8,       NULL,
                                                                                       0x0000},
        /*ECATCHANGE_END(V5.12) COE4*/
        /* Object 0x1C00 */
        {NULL, NULL, 0x1C00, {DEFTYPE_UNSIGNED8,     4 | (OBJCODE_ARR << 8)},
                asEntryDesc0x1C00, aName0x1C00, &sSyncmanagertype,         NULL, NULL,
                                                                                       0x0000},
        /* Object 0x1C32 */
        {NULL, NULL, 0x1C32, {DEFTYPE_SMPAR,         32 | (OBJCODE_REC << 8)},
                asEntryDesc0x1C3x, aName0x1C32, &sSyncManOutPar,           NULL, NULL,
                                                                                       0x0000},
        /* Object 0x1C33 */
        {NULL, NULL, 0x1C33, {DEFTYPE_SMPAR,         32 | (OBJCODE_REC << 8)},
                asEntryDesc0x1C3x, aName0x1C33, &sSyncManInPar,            NULL, NULL,
                                                                                       0x0000},
...
void COE_UpdateSyncErrorStatus(void) {
  if (sSyncManOutPar.u16CycleExceededCounter > 0
      || sSyncManOutPar.u16SmEventMissedCounter
         > sErrorSettings.u16SyncErrorCounterLimit) {
    sSyncManOutPar.u8SyncError = 1;
  } else {
    sSyncManOutPar.u8SyncError = 0;
  }

  if (sSyncManInPar.u16CycleExceededCounter > 0
...
void COE_Main(void) {
  ...
  if (pSdoPendFunc != NULL) {
    abort = pSdoPendFunc(u16StoreIndex, u8StoreSubindex, u32StoreDataSize,
                         pStoreData, bStoreCompleteAccess);
